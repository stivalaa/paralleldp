 ...
 * 
 *
 * $Id: bpaglobals.h 2584 2009-06-25 07:54:41Z astivala $
 *
 *****************************************************************************/
...
typedef struct bpaglobals_s 
{
    ...
    double gamma;          /* gap penalty (<=0) */
    double sigma_match;    /* score for matching base */
    double sigma_mismatch; /* score for mismatched base */
